...
Version  : 6.2.0
Release  : 60
URL      : https://download.kde.org/stable/frameworks/6.2/kcalendarcore-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/kcalendarcore-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kcalendarcore-6.2.0.tar.xz.sig
...
%setup -q -n kcalendarcore-6.2.0
cd %{_builddir}/kcalendarcore-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715621508
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CalendarCore.so.6.2.0
/usr/lib64/libKF6CalendarCore.so.6
/usr/lib64/libKF6CalendarCore.so.6.2.0
