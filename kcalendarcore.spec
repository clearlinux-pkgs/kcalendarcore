...
Version  : 5.115.0
Release  : 54
URL      : https://download.kde.org/stable/frameworks/5.115/kcalendarcore-5.115.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.115/kcalendarcore-5.115.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.115/kcalendarcore-5.115.0.tar.xz.sig
...
%prep
%setup -q -n kcalendarcore-5.115.0
cd %{_builddir}/kcalendarcore-5.115.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707695262
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5CalendarCore.so.5.115.0
/usr/lib64/libKF5CalendarCore.so.5
/usr/lib64/libKF5CalendarCore.so.5.115.0
