...
Version  : 5.99.0
Release  : 35
URL      : https://download.kde.org/stable/frameworks/5.99/kcalendarcore-5.99.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.99/kcalendarcore-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kcalendarcore-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kcalendarcore-5.99.0
cd %{_builddir}/kcalendarcore-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665412816
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5CalendarCore.so.5.99.0
