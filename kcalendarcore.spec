...
Version  : 6.4.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/6.4/kcalendarcore-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.4/kcalendarcore-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/kcalendarcore-6.4.0.tar.xz.sig
...
%setup -q -n kcalendarcore-6.4.0
cd %{_builddir}/kcalendarcore-6.4.0
pushd ..
cp -a kcalendarcore-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720812084
mkdir -p clr-build
pushd clr-build
