...
Version  : 6.14.0
Release  : 75
URL      : https://download.kde.org/stable/frameworks/6.14/kcalendarcore-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/kcalendarcore-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kcalendarcore-6.14.0.tar.xz.sig
...
%setup -q -n kcalendarcore-6.14.0
cd %{_builddir}/kcalendarcore-6.14.0
pushd ..
cp -a kcalendarcore-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747148700
mkdir -p clr-build
pushd clr-build
