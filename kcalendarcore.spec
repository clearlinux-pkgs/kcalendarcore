...
Version  : 5.95.0
Release  : 31
URL      : https://download.kde.org/stable/frameworks/5.95/kcalendarcore-5.95.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.95/kcalendarcore-5.95.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.95/kcalendarcore-5.95.0.tar.xz.sig
...
%prep
%setup -q -n kcalendarcore-5.95.0
cd %{_builddir}/kcalendarcore-5.95.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655132826
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcalendarcore-5.95.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kcalendarcore/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kcalendarcore-5.95.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcalendarcore/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kcalendarcore-5.95.0/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcalendarcore/757b86330df80f81143d5916b3e92b4bcb1b1890
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CalendarCore.so.5.95.0
