...
Source0  : https://download.kde.org/stable/frameworks/6.15/kcalendarcore-6.15.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.15/kcalendarcore-6.15.0.tar.xz.sig
...
%setup -q -n kcalendarcore-6.15.0
cd %{_builddir}/kcalendarcore-6.15.0
pushd ..
cp -a kcalendarcore-6.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750102095
mkdir -p clr-build
pushd clr-build
